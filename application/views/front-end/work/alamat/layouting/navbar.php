...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color:#fcd5b5;">
  ...
  <a href="<?=base_url()?>home?page=OURCITRUS" class="navbar-brand mx-auto order-0 order-md-2 p-2 btn-outline-danger btn-round">ourcitrus.id</a>
  ...
  <div class="navbar-collapse collapse dual-nav order-3 order-md-3">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link page-scroll" href="<?=base_url()?>#service">Service</a>
      </li>
    </ul>
  </div>
