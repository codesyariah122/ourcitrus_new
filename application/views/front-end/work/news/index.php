        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card-content">
                    <div class="card-img">
					<a href="<?=base_url()?>assets/img/news/news1/<?=$news_1['img_thumb']?>" data-toggle="lightbox" data-gallery="gallery">
					<img src="<?=base_url()?>assets/img/news/news1/<?=$news_1['img_thumb']?>" alt="" style="height:650px;">
					</a>             
                    ...
                    <div class="card-desc">
                        ...
                        <p><?=$news_1['content_feature']?></p>
                            <a href="<?=$news_1['link']?>" class="btn-card">Read More</a>   
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card-content">
                    <div class="card-img">
					<a href="<?=base_url()?>assets/img/news/news2/<?=$news_2['img_thumb']?>" data-toggle="lightbox" data-gallery="gallery">
                        <img src="<?=base_url()?>assets/img/news/news2/<?=$news_2['img_thumb']?>" alt="" style="height:530px;">
					</a>
