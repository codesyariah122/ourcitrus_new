...
<?php 
		...
		echo "background-image: url('".$img_url."assets/img/product/jumbotron/demoimage30.jpg');"; 
		else: 
...
<?php elseif($_SERVER['REQUEST_URI'] === '/Product/Nutrisi'):?>
		...
		<a href="<?=base_url()?>Product/kosmetik" class="btn btn-outline-info btn-round" data-aos="fade-left">Produk Kosmetik</a>
<?php else:?>
