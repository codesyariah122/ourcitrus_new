...
class InfoTerbaru Extends CI_Controller {
	...
	public function index() 
	{
			...
			$data['news_2']  = [
								...
								'date' => '2020-01-14',
								'content_feature' => 'Di Beritahukan Kepada seluruh member OURCITRUS yang ingin melakukan TOP UP AUTOMAINTAIN silahkan melakukan transfer nominal sesuai kekurangan saldo<br/>
